...
This is the runfile for the filter_unique_positions step, in which positions filter all sites that were defined as
editing sites at the previous step, under more than one editing category (e.g., non-repetitive and
hyper non-repetitive A to C), if they represented more than one type of nucleotide change
(e.g., once A to G and the other time A to C)
"""
