...
from Experiments.frontiers_jupyter.pipe_utils import all_genome_pair_combinations \
    , genome_3nt_all_combination_spec
from Experiments.frontiers_jupyter.directory_structure_definer import \
    DirectoryStructure, Stages, ConcensusStage
...
class PipeTester():
    ...
    def concensus_test(self, consensus_threshold=0.5):
        ...
        for node in graph_dict.keys():
            ...
            filtered_pileups = [dirstruct.pathName(fastq, node, Stages.concensus, ConcensusStage.filtered) for fastq in
                                positive_fastqs]
