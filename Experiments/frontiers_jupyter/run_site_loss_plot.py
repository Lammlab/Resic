...
This is the runfile for the site_loss_plot step, in which plots for site loss in each filtering step (such as no editing
filtering, editing threshold, etc).
...
class PipeTester():
    ...
    def site_loss_plot_test(self):
        ...
        dict_colors = calculate_dictionary_colors_for_site_loss()
...
def calculate_dictionary_colors_for_site_loss():
    dict_colors = {}
